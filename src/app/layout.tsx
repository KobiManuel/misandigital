...
export const metadata: Metadata = {
  ...
  description:
    "Assembling, Understanding, Customizing marketing plans, and much more! We specialize in bringing your vision to life by carefully considering your business plans and goals.",
  keywords: [
    "digital marketing",
    "SEO",
    "branding",
...
const WhatsAppFloat = () => {
  const whatsappNumber = "08134762781";
